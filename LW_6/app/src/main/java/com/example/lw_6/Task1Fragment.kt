...
class Task1Fragment : Fragment() {
    ...
    private fun calculateResults() {
        ...
        val result = """
        Kv = %.4f
        Ефективна кількість ЕП (n_e): %.2f
        Розрахунковий коефіцієнт активної потужності (Kp): %.2f
        Розрахункове активне навантаження (Pp): %.2f кВт
        ...
        n * Ph * Kv: %.2f 
        n * Ph^2: %.2f
    """.trimIndent().format(Kv, effectiveEP, Kp, Pp, Qp, Sp, Ip, quantityNum.toInt(), denominator, numerator, powerSquaredSum )
